const email_template = (body) => `<html>
    ...
    <div style="margin-top: 15px; text-align: center">
      ...
      <!-- Footer -->
         <div style="margin-top: 15px; text-align: center">
           ...
           /></a>
           <br />
           <p style="margin-top: 0.5rem">&copy; 2023 "TUITION HIGHWAY". All rights reserved.</p>
         </div>
         <!-- Footer -->
    </div>
  </div>
...
const get_email_template_for_reset_password = (username, resetURL) => {
  return email_template(`
      ...
      <p>Best wishes,<br /><b>The "TUITION HIGHWAY" Team</b></p>
    `);
};

module.exports = get_email_template_for_reset_password;
