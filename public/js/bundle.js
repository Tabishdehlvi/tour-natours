...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGFiaWktbWFwYm94IiwiYSI6ImNsdjI2emg0dDBjamoyaXJ5aTVzeHh4NDAifQ.UaFsCQ4rystkF4w1Edlqtw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/tabii-mapbox/clv28itez007u01pfecqudy0z',
    scrollZoom: false
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          console.log(res);
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', // type.charAt(0).toUpperCase() + type.slice(1) --> Captilize 1st letter
            "".concat(type.charAt(0).toUpperCase() + type.slice(1), " updated successfully!"));
          }
          _context.next = 12;
          break;
        case 9:
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var current_password, password, confirm_password;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
...
if (loginOutBtn) {
  loginOutBtn.addEventListener('click', _login.logout);
}
